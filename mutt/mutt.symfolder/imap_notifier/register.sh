...
/usr/local/bin/imap_notifier -v --file ~/.mutt/imap_notifier/gmail
/usr/local/bin/imap_notifier -v --file ~/.mutt/imap_notifier/brewbot
/usr/local/bin/imap_notifier -v --file ~/.mutt/imap_notifier/me
